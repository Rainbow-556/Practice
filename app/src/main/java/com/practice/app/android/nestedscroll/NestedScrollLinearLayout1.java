 ...
 */
public final class NestedScrollLinearLayout1 extends LinearLayout implements NestedScrollingParent {
    private TextView tvTitle;
    private View mTabView, mTopView, mListView;
    private NestedScrollingParentHelper mNestedScrollingParentHelper;

    public NestedScrollLinearLayout1(Context context) {
        super(context);
        init(context);
    }

    public NestedScrollLinearLayout1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NestedScrollLinearLayout1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
